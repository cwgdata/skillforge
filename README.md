...
| `app/` | Databricks App: FastAPI + a dark dashboard — KPIs, usage charts, discovered patterns (with purity badges), skill cards (template, params, A/B panel), and a **live test bench** that runs any skill through FMAPI. |
...
| `SKILLFORGE_CATALOG` / `SKILLFORGE_SCHEMA` | pipeline | Default `main` / `skillforge` |
